---
name: databricks-agent-run-locally
...
| **Authentication errors** | Verify `.env` is correct; run **databricks-agent-quickstart** skill |
...
- Deploy to Databricks: see **databricks-agent-deploy** skill
