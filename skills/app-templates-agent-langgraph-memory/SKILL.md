---
name: app-templates-agent-langgraph-memory
...
2. **Configure Lakebase** - See **app-templates-lakebase-setup** skill for:
...
After initializing tables, deploy your agent. See **app-templates-deploy** skill for full instructions.
...
- Configure Lakebase: see **app-templates-lakebase-setup** skill
- Test locally: see **app-templates-run-locally** skill
- Deploy: see **app-templates-deploy** skill
