---
name: databricks-agent-supervisor-api
...
See the **databricks-agent-supervisor-api-client-function-calling** skill for full implementation details, including function-only, streaming, mixed hosted + function, and MCP approval + function flow examples.
...
See the **databricks-agent-supervisor-api-background-mode** skill for full implementation details.
