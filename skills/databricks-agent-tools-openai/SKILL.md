---
name: databricks-agent-tools-openai
...
**Step 3:** Deploy with `databricks bundle deploy` (see **databricks-agent-deploy** skill)
...
For local function tools, see `databricks-agent-create-tools` skill > `examples/local-python-tools.md` for `failure_error_function` patterns.
