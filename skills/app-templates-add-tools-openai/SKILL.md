---
name: app-templates-add-tools-openai
...
**Step 3:** Deploy with `databricks bundle deploy` (see **app-templates-deploy** skill)
...
For local function tools, see `app-templates-create-tools` skill > `examples/local-python-tools.md` for `failure_error_function` patterns.
