---
name: app-templates-agent-openai-memory
...
2. **Lakebase instance**: You need a Databricks Lakebase instance. See the **app-templates-lakebase-setup** skill for creating and configuring one.
