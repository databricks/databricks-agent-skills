---
name: app-templates-migrate-from-model-serving
...
If you encounter issues during deployment, refer to the **app-templates-deploy** skill for detailed guidance.
...
If `databricks bundle deploy` fails because the app already exists, refer to the **app-templates-deploy** skill for instructions on binding an existing app to the bundle.
