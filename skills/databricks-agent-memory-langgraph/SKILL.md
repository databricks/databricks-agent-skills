---
name: databricks-agent-memory-langgraph
...
2. **Configure Lakebase** - See **databricks-agent-lakebase-setup** skill for:
...
After initializing tables, deploy your agent. See **databricks-agent-deploy** skill for full instructions.
...
- Configure Lakebase: see **databricks-agent-lakebase-setup** skill
