# Databricks Apps Platform Guide (Non-AppKit Frameworks)

This guide covers framework-specific setup for non-AppKit apps (Streamlit, FastAPI, Flask, Gradio, Dash, Django, Next.js, React, etc.).

For universal platform rules (permissions, deployment, timeouts, resource injection), see the main skill.
