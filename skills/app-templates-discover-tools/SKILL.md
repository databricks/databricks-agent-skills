---
name: app-templates-discover-tools
...
3. **Test locally** with `uv run start-app` - See **app-templates-run-locally** skill

Need a resource that doesn't exist yet? See the **app-templates-create-tools** skill.
