...
2. **Lakebase instance**: You need a Databricks Lakebase instance. See the [`lakebase-setup`](../lakebase-setup/lakebase-setup.md) reference for creating and configuring one.
