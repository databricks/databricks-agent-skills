...
**Step 3:** Deploy with `databricks bundle deploy` (see [`deploy`](../deploy/deploy.md) reference)
...
For local function tools, see [`create-tools`](../create-tools/create-tools.md) reference > `examples/local-python-tools.md` for `failure_error_function` patterns.
