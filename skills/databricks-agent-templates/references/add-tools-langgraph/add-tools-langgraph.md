...
> Don't have the resource yet? See [`create-tools`](../create-tools/create-tools.md) reference first.
...
See [`deploy`](../deploy/deploy.md) reference for more details.
...
For local function tools defined with `@tool`, see [`create-tools`](../create-tools/create-tools.md) reference > `examples/local-python-tools.md` for the `ToolException` + `handle_tool_error` pattern.
