...
If you encounter issues during deployment, refer to the [`deploy`](../deploy/deploy.md) reference for detailed guidance.
...
If `databricks bundle deploy` fails because the app already exists, refer to the [`deploy`](../deploy/deploy.md) reference for instructions on binding an existing app to the bundle.
