...
> **Prerequisite:** Lakebase must be configured. If not already set up, follow the [`lakebase-setup`](../lakebase-setup/lakebase-setup.md) reference first.
...
Add Lakebase resource and env vars per the [`lakebase-setup`](../lakebase-setup/lakebase-setup.md) reference. The long-running server additionally uses these optional env vars:
...
Add Lakebase connection vars (see [`lakebase-setup`](../lakebase-setup/lakebase-setup.md) reference for all options):
...
Follow the [`lakebase-setup`](../lakebase-setup/lakebase-setup.md) reference Steps 5-7 to deploy, grant SP permissions, and run the app.
...
| DB initialization failed warning | Lakebase connection error | Check env vars and permissions (see [`lakebase-setup`](../lakebase-setup/lakebase-setup.md) reference) |
