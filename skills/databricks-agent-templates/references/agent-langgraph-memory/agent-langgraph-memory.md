...
2. **Configure Lakebase** - See [`lakebase-setup`](../lakebase-setup/lakebase-setup.md) reference for:
...
After initializing tables, deploy your agent. See [`deploy`](../deploy/deploy.md) reference for full instructions.
...
- Configure Lakebase: see [`lakebase-setup`](../lakebase-setup/lakebase-setup.md) reference
- Test locally: see [`run-locally`](../run-locally/run-locally.md) reference
- Deploy: see [`deploy`](../deploy/deploy.md) reference
