---
name: databricks-agent-quickstart
...
1. Run `uv run discover-tools` to find available workspace resources (see **databricks-agent-discover-tools** skill)
2. Run `uv run start-app` to test locally (see **databricks-agent-run-locally** skill)
