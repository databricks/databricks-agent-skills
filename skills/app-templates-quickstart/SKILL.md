...
1. Run `uv run discover-tools` to find available workspace resources (see **app-templates-discover-tools** skill)
2. Run `uv run start-app` to test locally (see **app-templates-run-locally** skill)
