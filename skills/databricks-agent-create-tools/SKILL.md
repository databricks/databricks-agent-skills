---
name: databricks-agent-create-tools
...
1. **Discover** existing resources: `uv run discover-tools` (see **databricks-agent-discover-tools** skill)
...
4. **Deploy** (see **databricks-agent-deploy** skill)
