...
**FIRST**: Use the parent `databricks-cli` skill for CLI basics, authentication, profile selection, and data exploration commands.
...
Read the `databricks-cli` skill for CLI basics, authentication, and deployment workflow.
